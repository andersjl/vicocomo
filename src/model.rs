...
//! implement traits.  This is because the function names are generated by the
//! derive macros, and having an empty trait turned out rather unhelpful.
//!
//! Nevertheless, here follows the unhelpful code that is commented away:
//!
//! ### BelongsTo
//!
//! ```text

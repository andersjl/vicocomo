...
//
// Implements TryInto<other_type>, From<other_type> for DbValue::<variant>,
// and TryInto<Option<other_type>>, From<Option<other_type>> for
// DbValue::Nul<variant>.
//
...
// DbValue variant and the type other_type.  A missing or empty into_expr is
// taken as 'value as <other type>'.
//
// from_expr should use the variable other for the other_type value and the
// type contained in the DbValue variant.  A missiong or empty from_expr is
// taken as 'other as <the type contained in the variant>'.
//
//
